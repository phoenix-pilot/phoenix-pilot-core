...
{
	const vec_t nedZ = { .x = 0, .y = 0, .z = 1 }; /* z versor of NED frame of reference */
	const vec_t nedY = { .x = 0, .y = 1, .z = 0 }; /* y versor of NED frame of reference */
	const quat_t idenQ = { .a = 1, .i = 0, .j = 0, .k = 0 };
